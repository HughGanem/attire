 ...
 */function S(a){return f({...a,state:!0,attribute:!1})}const I=class I extends O{render(){return r`
  ...
  `;let m=I;var K=Object.defineProperty,q=Object.getOwnPropertyDescriptor,z=(a,e,t,s)=>{for(var i=s>1?void 0:s?q(e,t):e,n=a.length-1,o;n>=0;n--)(o=a[n])&&(i=(s?o(e,t,i):o(i))||i);return s&&i&&K(e,t,i),i};const x=class x extends k{constructor(){super("dreamin:model"),this.itemid="",this.edit=!1}get item(){return this.model.item}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),console.log("ATTRIBUTE CHANGED",e,t,s),e==="item-id"&&t!==s&&s&&(console.log("Item Page:",s),this.dispatchMessage(["item/select",{itemid:s}]))}render(){const e=this.item;return console.log("RENDER",this.itemid,this.item),e?this.edit?r`
        ...
        `:r`
          ...
          </div>`:r``}_handleSubmit(e){this.dispatchMessage(["item/save",{itemid:this.itemid,item:e.detail,onSuccess:()=>h.dispatch(this,"history/navigate",{href:`/app/items/${this.itemid}`}),onFailure:t=>console.log("ERROR:",t)}])}};x.uses=u({"mu-form":F.Element,"home-button":m}),x.styles=p`
    .link-container {
      display: flex;
      justify-content: center;
      align-items: center;
  ...
  `;let d=x;z([f({attribute:"item-id"})],d.prototype,"itemid",2);z([f({type:Boolean})],d.prototype,"edit",2);z([S()],d.prototype,"item",1);const v=class v extends k{constructor(){super("dreamin:model")}render(){return r`
      <div class="container">
        <p>Hi Hugh</p>
      </div>
    `}};v.uses=u({}),v.styles=p`
  ...
  `;let N=v;var Q=Object.defineProperty,X=Object.getOwnPropertyDescriptor,Z=(a,e,t,s)=>{for(var i=X(e,t),n=a.length-1,o;n>=0;n--)(o=a[n])&&(i=o(e,t,i)||i);return i&&Q(e,t,i),i};const w=class w extends k{get wishlistList(){return this.model.wishlistList||[]}constructor(){super("dreamin:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["wishlistList/select"])}render(){const e=t=>{const{name:s,budget:i,imageUrl:n,listid:o}=t;return r`
    ...
    `}_handleSubmit(e){this.dispatchMessage(["wishlist/create",{wishlist:e.detail,onSuccess:()=>{this.dispatchMessage(["wishlistList/select"]),h.dispatch(this,"history/navigate",{href:"/app/wishlists"})},onFailure:t=>console.log("ERROR:",t)}])}};w.uses=u({"home-button":m}),w.styles=p`
    .title-container {
      display: flex;
      background-color: var(--color-background-page-alt);
      border-radius: 25px;
  ...
  `;let b=w;Z([S()],b.prototype,"wishlistList");var H=Object.defineProperty,V=Object.getOwnPropertyDescriptor,$=(a,e,t,s)=>{for(var i=s>1?void 0:s?V(e,t):e,n=a.length-1,o;n>=0;n--)(o=a[n])&&(i=(s?o(e,t,i):o(i))||i);return s&&i&&H(e,t,i),i};const y=class y extends k{constructor(){super("dreamin:model"),this.listid="",this.edit=!1}get wishlist(){return this.model.wishlist}get items(){return this.model.itemList}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),console.log("ATTRIBUTE CHANGED",e,t,s),e==="list-id"&&t!==s&&s&&(console.log("Wishlist Page:",s),this.dispatchMessage(["wishlist/select",{listid:s}]),this.dispatchMessage(["wishlistItems/select",{listid:s}]))}render(){const e=this.wishlist,t=this.items;console.log("RENDER",this.listid,this.wishlist);const s=i=>r`
            ...
            `;return e?this.edit?r`
                ...
                `:r``}_handleCreateSubmit(e){this.dispatchMessage(["item/create",{listid:this.listid,item:e.detail,onSuccess:()=>{this.dispatchMessage(["wishlist/select",{listid:this.listid}]),h.dispatch(this,"history/navigate",{href:`/app/wishlists/${this.listid}`})},onFailure:t=>console.log("ERROR:",t)}])}_handleSubmit(e){this.dispatchMessage(["wishlist/save",{listid:this.listid,wishlist:e.detail,onSuccess:()=>h.dispatch(this,"history/navigate",{href:`/app/wishlists/${this.listid}`}),onFailure:t=>console.log("ERROR:",t)}])}};y.uses=u({"home-button":m}),y.styles=p`
        .link-container {
            display: flex;
            justify-content: center;
            align-items: center;
    ...
    `;let c=y;$([f({attribute:"list-id"})],c.prototype,"listid",2);$([f({type:Boolean})],c.prototype,"edit",2);$([S()],c.prototype,"wishlist",1);$([S()],c.prototype,"items",1);const tt=[{auth:"protected",path:"/app/items/:id",view:a=>r`
    ...
    `},{path:"/",redirect:"/app/wishlists"}];class et extends O{render(){return r`<mu-switch></mu-switch>`}connectedCallback(){super.connectedCallback(),g.initializeOnce()}}u({"mu-auth":l.Provider,"mu-history":h.Provider,"mu-store":class extends R.Provider{constructor(){super(M,_,"dreamin:auth")}},"mu-switch":class extends U.Element{constructor(){super(tt,"dreamin:history","dreamin:auth")}},"dreamin-app":et,"dreamcart-header":g,"item-view":d,"home-view":N,"wishlists-view":b,"wishlist-view":c});
